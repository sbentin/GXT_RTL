...
public class BasicBindingExample extends LayoutContainer {
  ...
  protected void onRender(Element parent, int index) {
    ...
    sb.append("<div class=text direction='rtl' style=' line-height: 1.5em'>");
    sb.append("<b>שם:</b> {name}<br>");
    sb.append("<b>סמל:</b> {symbol}<br>");
    sb.append("<b>אחרון:</b> {last}<br>");
    sb.append("<b>שינוי:</b> {[new Number(values.change).toFixed(2)]}<br>");
    sb.append("<b>עודכן ב:</b> {date:date(\"MM/dd/y\")}<br>");
    sb.append("</div>");
