...
public class CustomFormExample extends LayoutContainer {
	...
	private void createForm1() {
			...
			public void init(Component component) {
				component.addListener(Events.Render, new Listener<ComponentEvent>() {
					public void handleEvent(ComponentEvent be) {
						...
						elem.appendChild(XDOM.create("<div style='color: #615f5f;padding: 1 0 2 0px;'>" + be.getComponent().getData("text")
								+ "</div>"));
					}
				});
			}
		...
		FormLayout formLayout1 = new FormLayout(LabelAlign.LEFT);
		layout1.setLayout(formLayout1);
		...
		layout1.add(checkGroup, formData);
		...
		layout1.add(description, formData);
