...
public class PagingToolBar extends ToolBar {
  ...
  public class PagingToolBarImages {
    private AbstractImagePrototype first = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_first());
    private AbstractImagePrototype prev = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_prev());
    private AbstractImagePrototype next = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_next());
    private AbstractImagePrototype last = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_last());
    private AbstractImagePrototype refresh = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_refresh());

    private AbstractImagePrototype firstDisabled = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_first_disabled());
    private AbstractImagePrototype prevDisabled = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_prev_disabled());
    private AbstractImagePrototype nextDisabled = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_next_disabled());
    private AbstractImagePrototype lastDisabled = AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_last_disabled());
