...
/**
 * TabItems are added to a {@link TabPanel}. TabItems can be closable, disabled and support icons.
 * 
 * Code snippet:
 * 
 * <pre>
 ...
 * <div>Fires before an item is closed by the user clicking the close icon. Listeners can cancel the action by calling
