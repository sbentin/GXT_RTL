...
public class MultiField<D> extends Field<D> {
	...
	/**
	 * Sets the amount of spacing between fields. Spacing is applied to the right of each field for horizontal orientation and applied to
	 * the bottom of each field for vertical orientation (defaults to 0, pre-render).
	 * 
	 * @param spacing
