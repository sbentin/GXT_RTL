  ...
  protected Element getNextCell(Component component) {
    ...
    if (data.horizontalAlign != null) {
    	switch (data.horizontalAlign) {
    		case START: {
    			if (LocaleInfo.getCurrentLocale().isRTL())
    				td.dom.setPropertyString("align", "right");
    			else
    				td.dom.setPropertyString("align", "left");
    			break;
    		}
    		case END : {
    			if (LocaleInfo.getCurrentLocale().isRTL())
    		...
    		default:
    			td.dom.setPropertyString("align", data.horizontalAlign.name().toLowerCase());
    	}
    	...
    	switch (cellHorizontalAlign) {
    		...
    		default:
    			td.dom.setPropertyString("align", cellHorizontalAlign.name().toLowerCase());
    	}      
    }
